...
async function fundAddress(dapiClient, faucetAddress, faucetPrivateKey, address) {
  ...
  // const randomPrivateKey = new PrivateKey();
  // const randomAddress = randomPrivateKey.toAddress(network);
...
async function createIdentity(dapiClient, privateKey, type) {
  ...
  // await dapiClient.generateToAddress(10, lockAddress.toString());
  // await wait(5000);

  //   const randomPrivateKey = new PrivateKey();
  // const randomAddress = randomPrivateKey.toAddress(network);
  // await dapiClient.generateToAddress(1, randomAddress);
  // await wait(5000);

  // await dapiClient.generateToAddress(2, lockAddress.toString());
